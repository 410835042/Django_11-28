        ...
        if (hand_width.length>4 && hand_length.length>4 && palm.length>4){
            model.traverse(function(child){
                if (child.name.indexOf("thumb_1") != -1) {child.scale.set(
                    Number(thumb_w.textContent)/4.0, Number(thumb_l.textContent)/4.0, Number(thumb_l.textContent)/4.0);}
                if (child.name.indexOf("index_1") != -1) {child.scale.set(
                    Number(index_w.textContent)/4.0, Number(index_l.textContent)/4.0,Number(index_l.textContent)/4.0);}
                if (child.name.indexOf("middle_1") != -1) {child.scale.set(
                    Number(middle_w.textContent)/4.0, Number(middle_l.textContent)/4.0, Number(middle_l.textContent)/4.0);}
                if (child.name.indexOf("ring_1") != -1) {child.scale.set(
                    Number(ring_w.textContent)/4.0, Number(ring_l.textContent)/4.0, Number(ring_l.textContent)/4.0);}
                if (child.name.indexOf("little_1") != -1) {child.scale.set(
                    Number(little_w.textContent)/4.0, Number(little_l.textContent)/4.0, Number(little_l.textContent)/4.0);}
                if (child.name.indexOf("palme") != -1) {child.scale.set(
                    1, Number(palm_l.textContent), Number(palm_w.textContent));}
            })
        }
